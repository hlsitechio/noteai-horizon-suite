  ...
  return (
    <div className="grid grid-cols-4 gap-2">
      {stats.map((stat, index) => {
        ...
        return (
          <Card key={index} className="border border-border/10 shadow-sm bg-card/50 backdrop-blur-xl hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:scale-102 rounded-lg">
            <CardContent className="p-2.5">
              <div className="flex items-center justify-between">
                ...
                <div className="rounded-lg bg-gradient-to-br from-accent/10 to-accent/5 flex items-center justify-center border border-accent/10 w-8 h-8">
                  <IconComponent className="text-accent w-4 h-4" />
                </div>
              </div>
            </CardContent>
          </Card>
