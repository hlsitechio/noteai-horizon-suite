...
export const WelcomeStep: React.FC<WelcomeStepProps> = ({
  ...
  return <div className={`min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center p-4 ${className}`}>
      <Card className="w-full max-w-4xl mx-auto border-2 border-primary/10 shadow-2xl">
        ...
        <CardContent className="pb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            return <div key={index} className="flex items-start space-x-4 p-4 rounded-lg border border-border/50 bg-card/50">
        ...
        <CardContent className="pt-0">
          <div className="w-full text-center space-y-4">
            <Button onClick={onGetStarted} className="h-12 px-8 text-base font-medium text-white bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary" size="lg">
              Let's Get Started
