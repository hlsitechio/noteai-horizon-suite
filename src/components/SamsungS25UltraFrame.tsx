  ...
  return (
    ...
    >
      ...
      <div className="relative w-[360px] h-[780px] rounded-[50px] border-[14px] border-[#3a3a3f] bg-gradient-to-b from-[#1b1b1d] to-[#101013] shadow-2xl overflow-hidden">
        ...
        <div className="absolute inset-0 rounded-[42px] border border-[#61699E]/30 shadow-inner shadow-[#58A6D0]/10 pointer-events-none" />

        {/* Speaker and camera layout */}
        <div className="absolute top-[10px] left-1/2 transform -translate-x-1/2 flex items-center gap-1 z-10">
          {/* Speaker grill */}
        ...
        {/* Screen - Mobile Content Container */}
        <div className="absolute top-0 left-0 w-full h-full bg-background rounded-[36px] overflow-hidden">
          {children}
        </div>
      </div>
    </motion.div>
