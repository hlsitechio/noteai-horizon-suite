        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><a href="/features" target="_self" className="hover:text-cyan-400 transition-colors">Features</a></li>
              <li><a href="/pricing" target="_self" className="hover:text-cyan-400 transition-colors">Pricing</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><a href="/about" target="_self" className="hover:text-cyan-400 transition-colors">About</a></li>
              <li><a href="/contact" target="_self" className="hover:text-cyan-400 transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><a href="/privacy" target="_self" className="hover:text-cyan-400 transition-colors">Privacy</a></li>
              <li><a href="/terms" target="_self" className="hover:text-cyan-400 transition-colors">Terms</a></li>
              <li><a href="/sitemap" target="_self" className="hover:text-cyan-400 transition-colors">Sitemap</a></li>
            </ul>
          </div>
        </div>
