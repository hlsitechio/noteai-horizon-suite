        ...
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <motion.div variants={badgeVariants} animate="animate" transition={{
              delay: 0.5
            }}>
          ...
          <div className="flex items-center gap-3">
            ...
            scale: 0.95
              ...
              <Button variant="ghost" size="icon" onClick={handleNotificationClick} className="relative glass shadow-medium hover:bg-white/20 dark:hover:bg-slate-700/30">
                <motion.div animate={{
                rotate: [0, 10, 0, -10, 0]
              }} transition={{
                duration: 2,
                ...
                {unreadCount > 0 && <motion.div animate={{
                scale: [1, 1.2, 1]
              }} transition={{
                duration: 1,
                repeat: Infinity,
                repeatType: "reverse" as const
                    ...
                    <Badge className="absolute -top-1 -right-1 h-5 min-w-5 p-0 bg-red-500 border-0 text-xs">
            ...
            scale: 0.95
              ...
              <Button variant="ghost" size="icon" onClick={handleThemeToggle} className="glass shadow-medium hover:bg-white/20 dark:hover:bg-slate-700/30">
                <AnimatePresence mode="wait">
                  {isCurrentlyDark ? <motion.div key="sun" variants={iconVariants} initial={{
                  scale: 0,
                  rotate: -180
                }} animate={{
                  scale: 1,
                  ...
                  rotate: 180
                    ...
                    </motion.div> : <motion.div key="moon" variants={iconVariants} initial={{
                  scale: 0,
                  rotate: 180
                }} animate={{
                  scale: 1,
