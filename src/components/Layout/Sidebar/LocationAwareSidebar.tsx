...
const SidebarBrand = () => (
  <div className="flex items-center gap-3 px-6 py-4 border-b border-border/50">
    ...
    <div className="flex flex-col">
      <span className="text-sm font-semibold text-foreground">Thor</span>
...
const NavigationItem = ({ route, isActive }: NavigationItemProps) => {
  ...
  return (
    <Link to={route.path} className="block px-3 mx-3">
      <Button
...
const SidebarContent = ({ routes, currentPath }: { routes: RouteConfig[], currentPath: string }) => {
...
const SidebarDescription = ({ routes, currentPath }: { routes: RouteConfig[], currentPath: string }) => {
  return (
