    ...
    <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} relative px-2`}>
      ...
      <div className={`flex items-center gap-3 ${isCollapsed ? 'justify-center' : ''}`}>
        ...
        <AnimatePresence>
          {!isCollapsed && (
            ...
            >
              <span className="text-lg font-bold text-sidebar-foreground">AI Notes</span>
              <span 
      ...
      >
        <Button
          ...
          className="h-8 w-8 rounded-lg hover:bg-sidebar-accent text-sidebar-foreground/70 hover:text-sidebar-foreground transition-colors"
