    ...
    const newUserFlow: OnboardingFlow = {
      ...
      steps: [
        ...
        },
        {
          ...
          target: '[data-onboarding="feature-menu"]',
          content: 'Explore these features to get the most out of your workspace. Don\'t worry, you can always come back to learn more.',
          position: 'left',
          required: false,
          completed: false,
          category: 'features'
