-- Create WebAuthn schema and tables for passkey authentication
...
-- Create indexes
CREATE UNIQUE INDEX credentials_pkey ON webauthn.credentials (id);
CREATE UNIQUE INDEX credentials_credential_id_key ON webauthn.credentials (credential_id);
CREATE UNIQUE INDEX challenges_pkey ON webauthn.challenges (id);
CREATE UNIQUE INDEX challenges_value_key ON webauthn.challenges (value);
